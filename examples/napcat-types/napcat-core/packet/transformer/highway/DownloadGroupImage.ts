...
declare class DownloadGroupImage extends PacketTransformer<typeof proto.NTV2RichMediaResp> {
    build(group_uin: number, node: any): OidbPacket;
...
declare const _default: DownloadGroupImage;
