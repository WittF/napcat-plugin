...
declare class DownloadGroupVideo extends PacketTransformer<typeof proto.NTV2RichMediaResp> {
    build(groupUin: number, node: any): OidbPacket;
...
declare const _default: DownloadGroupVideo;
