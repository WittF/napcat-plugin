...
import { GroupExt0xEF0InfoFilter, GroupExtParam, GroupInfoSource, GroupMember, NTGroupMemberRole, GroupNotifyMsgType, NTGroupRequestOperateTypes, KickMemberV2Req, GroupDetailInfoV2Param, GroupExtInfo, GroupExtFilter } from '../types';
...
export interface NodeIKernelGroupService {
    ...
    getNextMemberList(sceneId: string, groupMemberInfoListId: {
        index: number;
        uid: string;
    } | undefined, num: number): Promise<{
        errCode: number;
        errMsg: string;
        result: {
            ids: string[];
