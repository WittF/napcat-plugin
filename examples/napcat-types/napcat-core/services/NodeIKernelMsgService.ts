import { ElementType, MessageElement, Peer, RawMessage, FileElement, SendMessageElement } from '../types';
...
export interface NodeIKernelMsgService {
    ...
    getMsgsWithMsgTimeAndClientSeqForC2C(...args: unknown[]): Promise<GeneralCallResult & {
        msgList: RawMessage[];
    }>;
    ...
    getMsgWithAbstractByFilterParam(...args: unknown[]): Promise<GeneralCallResult & {
        msgList: RawMessage[];
    }>;
    queryMsgsWithFilter(...args: unknown[]): Promise<GeneralCallResult & {
        msgList: RawMessage[];
    }>;
