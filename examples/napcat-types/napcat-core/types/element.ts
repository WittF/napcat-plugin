import { ElementType, MessageElement, NTGrayTipElementSubTypeV2, PicSubType, PicType, TipAioOpGrayTipElement, TipGroupElement, NTVideoType, FaceType, Peer } from './msg';
...
type ElementBase<K extends keyof ElementFullBase, S extends Partial<{
    [P in K]: keyof NonNullable<ElementFullBase[P]> | Array<keyof NonNullable<ElementFullBase[P]>>;
}> = object> = {
    [P in K]: S[P] extends Array<infer U> ? Pick<NonNullable<ElementFullBase[P]>, U & keyof NonNullable<ElementFullBase[P]>> : S[P] extends keyof NonNullable<ElementFullBase[P]> ? Pick<NonNullable<ElementFullBase[P]>, S[P]> : NonNullable<ElementFullBase[P]>;
};
...
export type SendMessageElement = SendTextElement | SendPttElement | SendPicElement | SendReplyElement | SendFaceElement | SendMarketFaceElement | SendFileElement | SendVideoElement | SendArkElement | SendMarkdownElement | SendShareLocationElement;
export {};
