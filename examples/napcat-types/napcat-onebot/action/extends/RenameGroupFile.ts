...
declare const PayloadSchema: import("@sinclair/typebox").TObject<{
    ...
    new_name: import("@sinclair/typebox").TString;
}>;
...
export declare class RenameGroupFile extends GetPacketStatusDepends<PayloadType, ReturnType> {
    actionName: "rename_group_file";
