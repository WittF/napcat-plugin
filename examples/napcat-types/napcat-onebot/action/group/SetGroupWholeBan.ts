...
declare const PayloadSchema: import("@sinclair/typebox").TObject<{
    ...
    enable: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TBoolean, import("@sinclair/typebox").TString]>>;
}>;
...
export default class SetGroupWholeBan extends OneBotAction<PayloadType, ReturnType> {
    actionName: "set_group_whole_ban";
