...
import { OB11Message } from '../types/message';
...
export type QuickAction = QuickActionPrivateMessage & QuickActionGroupMessage & QuickActionFriendRequest & QuickActionGroupRequest;
